...
import com.shaxian.biz.appservice.purchase.PurchaseAppService;
...
public class PurchaseController {
    ...
    public ResponseEntity<ApiResponse<List<PurchaseOrder>>> getAllPurchases(
            ...
            @RequestBody(required = false) com.shaxian.biz.dto.purchase.request.PurchaseOrderQueryRequest request,
            UserSession session) {
    ...
    public ResponseEntity<ApiResponse<PurchaseOrder>> createPurchase(
            @RequestBody com.shaxian.biz.dto.purchase.request.CreatePurchaseOrderRequest request,
            UserSession session) {
    ...
    public ResponseEntity<ApiResponse<PurchaseOrder>> updatePurchase(
            @Parameter(description = "采购订单ID", required = true) @PathVariable Long id,
            @RequestBody com.shaxian.biz.dto.purchase.request.UpdatePurchaseOrderRequest request,
            UserSession session) {
