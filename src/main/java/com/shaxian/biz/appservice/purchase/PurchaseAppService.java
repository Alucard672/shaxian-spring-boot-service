package com.shaxian.biz.appservice.purchase;

import com.shaxian.biz.entity.PurchaseOrder;
import com.shaxian.biz.entity.PurchaseOrderItem;
import com.shaxian.biz.service.purchase.PurchaseService;
...
public class PurchaseAppService {
    ...
    public PurchaseOrder createPurchase(com.shaxian.biz.dto.purchase.request.CreatePurchaseOrderRequest request) {
    ...
    public PurchaseOrder updatePurchase(Long id, com.shaxian.biz.dto.purchase.request.UpdatePurchaseOrderRequest request) {
        PurchaseOrder order = buildOrderFromRequest(request);
        List<PurchaseOrderItem> items = buildItemsFromRequest(request);
    ...
    private PurchaseOrder buildOrderFromRequest(Object requestObj) {
        ...
        if (requestObj instanceof com.shaxian.biz.dto.purchase.request.CreatePurchaseOrderRequest) {
            com.shaxian.biz.dto.purchase.request.CreatePurchaseOrderRequest request = (com.shaxian.biz.dto.purchase.request.CreatePurchaseOrderRequest) requestObj;
        ...
        } else if (requestObj instanceof com.shaxian.biz.dto.purchase.request.UpdatePurchaseOrderRequest) {
            com.shaxian.biz.dto.purchase.request.UpdatePurchaseOrderRequest request = (com.shaxian.biz.dto.purchase.request.UpdatePurchaseOrderRequest) requestObj;
    ...
    private List<PurchaseOrderItem> buildItemsFromRequest(Object requestObj) {
        java.util.List<com.shaxian.biz.dto.purchase.request.PurchaseOrderItemRequest> itemsData = null;
        if (requestObj instanceof com.shaxian.biz.dto.purchase.request.CreatePurchaseOrderRequest) {
            itemsData = ((com.shaxian.biz.dto.purchase.request.CreatePurchaseOrderRequest) requestObj).getItems();
        } else if (requestObj instanceof com.shaxian.biz.dto.purchase.request.UpdatePurchaseOrderRequest) {
            itemsData = ((com.shaxian.biz.dto.purchase.request.UpdatePurchaseOrderRequest) requestObj).getItems();
        }
